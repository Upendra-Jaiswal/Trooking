...
const Hero = () => {
  ...
  const isMobile = window.innerWidth <= 1024; // Adjust the breakpoint as necessary
  ...
  return (
    <section className="relative bg-gray-100  overflow-hidden flex">
      <>
        {isMobile ? (
          <div className="flex flex-col w-full">
            {/* First Row with Two Columns */}
            <div className="flex justify-between gap-4 w-full px-4">
              <div className="bg-white rounded-2xl p-4 w-1/2 text-center">
                4095 reviews
              </div>
              <div className="bg-white  rounded-2xl p-4 w-1/2 text-center">
                4.5 star reviews
            ...
            <div
              className="m-4 p-6 h-48 bg-cover bg-center rounded-xl"
                    ...
                    >
                      ...
                      <div className="w-2/3 pl-4">
                        <div className="flex mb-2">
                          {[...Array(reviews[index].rating)].map(
                            (_, starIndex) => (
                              <FaStar
                                key={starIndex}
