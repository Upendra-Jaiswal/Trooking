              ...
              <div>
                ...
                <div className="flex gap-4 mb-4">
                  ...
                  <div className="flex-1 overflow-hidden rounded-2xl shadow-md">
                    <img
                      src={
                        imageUrls[(currentImageIndex + 1) % imageUrls.length]
                      }
                      alt="Slide 2"
                      className="w-full h-64 object-cover cursor-pointer"
                      onClick={() =>
                        handleBookClick(
                          trips[(currentImageIndex + 1) % trips.length]
                        )
                      }
                    />
                  </div>
                ...
                <div className="flex gap-4">
                  <div className="flex-1 overflow-hidden rounded-2xl shadow-md">
                    <img
                      src={
                        imageUrls[(currentImageIndex + 2) % imageUrls.length]
                      }
                      alt="Slide 3"
                      className="w-full h-64 object-cover cursor-pointer"
                      onClick={() =>
                  ...
                  <div className="flex-1 overflow-hidden rounded-2xl shadow-md">
                    <img
                      src={
                        imageUrls[(currentImageIndex + 3) % imageUrls.length]
                      }
                      alt="Slide 4"
                      className="w-full h-64 object-cover cursor-pointer"
                      onClick={() =>
