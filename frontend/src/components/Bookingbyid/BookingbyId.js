          ...
          <div className="bg-white rounded-2xl p-2 my-4">
            <div className="p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                Elevated at 12,500 ft, Kedarkantha is one of the majestic peaks
                of the great Himalayan range. As one of the most popular winter
                treks, Kedarkantha fascinates numerous hikers and trekkers from
                all over the country. It is perfect for both beginners and
                experts. This 4-night, 5-day trek is curated to accommodate
                those who love both the serenity and the adventure that nature,
                with its unpredictable trails and mystical valleys, can provide.
                <br />
                <br />
                ...
                translates to “The Throat of Lord Shiva,” and its association
                with Lord Shiva, along with local myths and folklores, adds to
                its charm and enriches the experience.
                <br />
                <br />
                We will begin our journey from Dehradun and make our way to the
                small village of Sankri, which serves as the base camp for this
                20 km long trek. We will spend a night at our designated
                homestay or hotel, introducing ourselves and exchanging stories
                before retiring for the night. The next day, after a briefing
                session from our trek leader, we will proceed to our first
                checkpoint, Juda Ka Taal, where we will spend a leisurely day at
                the campsite, enjoying lunch and dinner.
              </p>
            </div>
          </div>
              ...
              {openDay === 1 && (
                <div className="pl-4 text-gray-700">
                  <p>
                    ...
                    We'll drive towards Sankri village which is the base camp
                    for the Kedarkantha Trek.
                  </p>
                  <p>
                    Upon reaching Sankri, we'll check in to our designated
                    homestay. The rest of the day is at leisure and travelers
                    are advised to rest.
                  </p>
                  <p>
              ...
              {openDay === 3 && (
                <div className="pl-4 text-gray-700">
                  <p>
                    ...
                    proceed towards Kedarkantha Base Camp with a briefing from
                    the trek leader.
                  </p>
                  <p>
                ...
                <div className="pl-4 text-gray-700">
                  ...
                  <p>
                    *Additionally, you get a 360-degree view of the whole
                    ...
                    are Gangotri, Swargarohini, Banderpooch, Kinner Kailash,
                    etc.
                  </p>
                </div>
              )}
              ...
              {openDay === 5 && (
                <div className="pl-4 text-gray-700">
                  <p>
                    ...
                    up, have lunch, and then proceed back to Dehradun, arriving
                    by late evening.
                  </p>
                  <p>
