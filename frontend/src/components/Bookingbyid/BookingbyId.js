...
const MyComponent = () => {
  ...
  useEffect(() => {
    if (trip) {
      setTrips([trip]); // Wrap the object in an array
    }
  }, [trip]);
                ...
                <div className="w-7/12 flex flex-col h-full rounded-2xl p-8 m-3">
                  ...
                  <div className="bg-white rounded-2xl p-2 my-4">
                    <div className="p-6">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Elevated at 12,500 ft, Kedarkantha is one of the
                        majestic peaks of the great Himalayan range. As one of
                        the most popular winter treks, Kedarkantha fascinates
                        numerous hikers and trekkers from all over the country.
                        It is perfect for both beginners and experts. This
                        4-night, 5-day trek is curated to accommodate those who
                        love both the serenity and the adventure that nature,
                        with its unpredictable trails and mystical valleys, can
                        provide.
                        <br />
                        <br />
                        Popular for its spectacular view of snow-capped
                        mountains, the summit offers glimpses of several ranges,
                        including Black Peak, Swargarohini, Gangotri, and
                        Yamunotri. The summit's name translates to “The Throat
                        of Lord Shiva,” and its association with Lord Shiva,
                        along with local myths and folklores, adds to its charm
                        and enriches the experience.
                        <br />
                        <br />
                        We will begin our journey from Dehradun and make our way
                        to the small village of Sankri, which serves as the base
                        camp for this 20 km long trek. We will spend a night at
                        our designated homestay or hotel, introducing ourselves
                        and exchanging stories before retiring for the night.
                        The next day, after a briefing session from our trek
                        leader, we will proceed to our first checkpoint, Juda Ka
                        Taal, where we will spend a leisurely day at the
                        campsite, enjoying lunch and dinner.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl p-8 my-4">
                      ...
                      {openDay === 1 && (
                        <div className="pl-4 text-gray-700">
                          <p>
                            ...
                            AM. We'll drive towards Sankri village which is the
                            base camp for the Kedarkantha Trek.
                          </p>
                          <p>
                            Upon reaching Sankri, we'll check in to our
                            designated homestay. The rest of the day is at
                            leisure and travelers are advised to rest.
                          </p>
                          <p>
                          ...
                          <p>
                            <strong>Pickup Point:</strong> Nearby Dehradun
                            Railway Station
                          </p>
                          <p>
                    ...
                    <div className="border-b border-gray-300">
                      ...
                      >
                        <h3 className="font-semibold">
                          2 Day: Trek from Sankri to Juda Ka Taal (4 Kilometers,
                          4 Hours Trek)
                        </h3>
                      ...
                      {openDay === 2 && (
                        <div className="pl-4 text-gray-700">
                          <p>
                            After early morning breakfast, a small briefing
                            session will be conducted by the trek leader. We
                            will start our trekking journey through lush green
                            forests of pine trees.
                          </p>
                          <p>
                            We'll reach Juda Ka Taal after four hours of
                            trekking. Lunch will be served at the campsite. The
                            rest of the day is at leisure, followed by dinner
                            and an overnight stay at Juda Ka Taal Campsite.
                          </p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="border-b border-gray-300">
                      ...
                      {openDay === 3 && (
                        <div className="pl-4 text-gray-700">
                          <p>
                            Morning tea will be followed by breakfast, then
                            we’ll proceed towards Kedarkantha Base Camp with a
                            briefing from the trek leader.
                          </p>
                          <p>
                            The 3-4 hour trek will take us to the base camp,
                            where we’ll enjoy lunch and have some leisure time
                            for activities like snowball fights before dinner
                    ...
                    <div className="border-b border-gray-300">
                      ...
                      >
                        <h3 className="font-semibold">
                          4 Day: Trek To Kedarkantha Peak | Back To Juda ka Taal
                          (9 Kilometers, 8 Hours Trek)
                        </h3>
                      ...
                      {openDay === 4 && (
                        <div className="pl-4 text-gray-700">
                          <p>
                            ...
                            Kedarkantha Summit. After enjoying the stunning
                            sunrise and views from the summit, we’ll return to
                            Kedarkantha Base Camp for lunch and a farewell
                            celebration.
                          </p>
                          <p>
                          ...
                          <p>
                            *Additionally, you get a 360-degree view of the
                            whole Himalayan Region from the Kedarkantha Top.
                            Some of the peaks are Gangotri, Swargarohini,
                            Banderpooch, Kinner Kailash, etc.
                          </p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="border-b border-gray-300">
                      ...
                      >
                        <h3 className="font-semibold">
                          5 Day: Juda ka Taal To Sankri (4 Kilometers, 4 Hours
                          Trek) | Back To Dehradun (8 Hours Drive)
                        </h3>
                      ...
                      {openDay === 5 && (
                        <div className="pl-4 text-gray-700">
                          ...
                          <p>
                            <strong>Note:</strong> It is recommended to book
                            your return bus after 11:00 PM.
                          </p>
                        </div>
                      )}
                    </div>
                ...
                <div className="w-5/12 h-full bg-white rounded-2xl shadow-lg p-6 m-3 flex flex-col justify-between">
                  ...
                  <div className="flex items-center mb-6">
                    ...
                    <div className="w-6/12 text-right">
                      <p className="text-gray-800 text-lg font-bold">
                        Total: ₹{numberOfPersons * item.price}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center">
                    <Link
                      ...
                      state={{
                        amount: numberOfPersons * item.price,
                        bookingDetails: {
                          tripId: item._id,
                          tripName: item.name,
                          route: item.route,
